...
def main(): 
    ...
    parser.add_argument('folder_name', help='Название директории с изображениями', type=str)
    parser.add_argument('number_of_photos', help='Количество изображений', type=int)
